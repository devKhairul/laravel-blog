<header class="max-w-xl mx-auto mt-20 text-center">
    <h1 class="text-4xl">
        Latest <span class="text-blue-500">Laravel </span> Tidbits
    </h1>
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{show: false}" @click.away = "show = false">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 w-full z-50 overflow-auto max-h-52" style="display: none">
                    ...
                    @foreach ($categories as $category )
                        <a href="/?category={{ $category->slug }}"
                            ...
                            hover:text-white focus:text-white {{ isset($currentCategory) && $currentCategory->is($category) ? 'bg-blue-500 text-white' : '' }}">{{ ucwords($category->name) }}</a>
                    @endforeach
                </div>
            </div>
